                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-7">
                            <div class="header__top__left">
                                <p style={{ fontWeight: 'bold', paddingTop: 7 }}>You can Download SWAPHA App from  <span> <Link style={{ color: 'white' }} to='/'> AppStore <FaAppStore style={{ fontSize: "20px" }} /> </Link> </span> </p>
                            </div>
                        </div>
